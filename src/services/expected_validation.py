...
MUTUALLY_EXCLUSIVE_PAIRS = [
    ...
    ('NO_IDP', 'HAS_IDP'),
    ('NO_CMDB', 'HAS_CMDB'),
    ('HAS_VISIBILITY', 'MISSING_VISIBILITY'),
    ('HAS_VALIDATION', 'MISSING_VALIDATION'),
    ('HAS_CONTROL', 'MISSING_CONTROL'),
    ('GOVERNANCE_TRINITY_PASS', 'GOVERNANCE_TRINITY_FAIL'),
]

IMPLICATION_RULES = [
    ('HAS_ONGOING_FINANCE', 'HAS_FINANCE'),
    ('HAS_VISIBILITY', 'HAS_CMDB'),
    ('HAS_CONTROL', 'HAS_IDP'),
    ('GOVERNANCE_TRINITY_PASS', 'HAS_VISIBILITY'),
    ('GOVERNANCE_TRINITY_PASS', 'HAS_VALIDATION'),
    ('GOVERNANCE_TRINITY_PASS', 'HAS_CONTROL'),
]
